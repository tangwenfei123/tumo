...
CREATE TABLE `tb_article_category` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8 COMMENT='文章&&分类关联表';
...
CREATE TABLE `tb_article_tag` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=51 DEFAULT CHARSET=utf8 COMMENT='文章&&标签关联表';
...
CREATE TABLE `tb_link` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='友链表';
...
CREATE TABLE `tb_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=90 DEFAULT CHARSET=utf8 COMMENT='系统日志表';
...
INSERT INTO `tb_log` VALUES (89, 'tycoding', '删除文章', 0, 'cn.tycoding.biz.controller.ArticleController.delete()', NULL, '127.0.0.1', '2020-06-28 23:07:57', '内网IP|0|0|内网IP|内网IP');
COMMIT;
...
INSERT INTO `tb_login_log` VALUES (102, 'tycoding', '127.0.0.1', '内网IP|0|0|内网IP|内网IP', '2020-06-28 23:06:02', 'Chrome 8 -- Mac OS X');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `tb_user` VALUES (1, 'tycoding', 'c82a27d50dd5f3a536c85211cc7f2346', 'https://tycoding.cn/images/avatar.jpg', 'tytumo@163.com', '兴趣使然的Coder', '2020-06-27 16:55:05');
INSERT INTO `tb_user` VALUES (2, 'test', 'test', NULL, NULL, NULL, '2020-06-26 16:55:08');
INSERT INTO `tb_user` VALUES (3, 'test2', 'test', NULL, '12tycoding@11.com', NULL, '2020-06-27 16:55:13');
COMMIT;
